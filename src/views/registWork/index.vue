<template>
  ...
  <div>
    <aside>
      ...
      <el-button style="float:right;margin-left:20px" type="text" size="medium" @click="reprint">
      ...
      <el-button style="float:right;margin-left:20px" type="text" size="medium" @click="guahao">
...
<!-- 
    <div v-if="!dialogFormVisible&&!isshow&&!refundVisible">
      ...
      <el-button style="float:right;margin-right:30px" type="text" @click="refresh" size="medium">
      ...
      <el-form :model="onepatient" label-width="80px" label-position="left" :inline="true">
        <el-form-item label="病历号" prop="id" label-width="60px">
          <el-tag
            ...
            size="large"
            placeholder="病历号"
          >{{onepatient.medicalRecordNo}}</el-tag>
        </el-form-item>
        ...
        <el-form-item label="看诊日期" prop="birth" label-width="70px">
          <el-tag
            ...
            size="large"
            placeholder="病历号"
          >{{onepatient.attendanceDate}}</el-tag>
        </el-form-item>
      </el-form>
    ...
    <!-- <div v-show="refundVisible" style="text-align:center">
      ...
      <el-table stripe border :data="paylist" @selection-change="handlechange">
        ...
        <el-table-column align="center" label="发票号" width="250px">
          <template slot-scope="scope">{{scope.row.invoiceIdfNo}}</template>
        </el-table-column>
        <el-table-column align="center" label="项目名称">
          <template slot-scope="scope">
            <span>{{ scope.row.name}}</span>
