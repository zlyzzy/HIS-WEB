<template>
  <div>
    ...
    <el-dialog title="诊断目录" :visible.sync="dialogTableVisible" top="50px">
      ...
      <pagination :auto-scroll="false" style="margin-top:0px" v-show="total>0" :total="total" :page-sizes="[10,20]" :page.sync="disQuery.pageNum" :limit.sync="disQuery.pageSize" @pagination="getDis" />
      </div>
  </el-dialog>
  </div>
</template>
